...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      for val1 in self.action_result.result.ik_solutions:
        ...
        for val2 in val1.attached_collision_objects:
          ...
          for val4 in _v13.plane_poses:
            ...
            _x = _v22
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v13.operation))
        ...
        buff.write(_get_struct_B().pack(val1.is_diff))
      _x = self
      ...
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_feedback.feedback.ik_solution.joint_state.position))
      length = len(self.action_feedback.feedback.ik_solution.joint_state.velocity)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_feedback.feedback.ik_solution.joint_state.velocity))
      length = len(self.action_feedback.feedback.ik_solution.joint_state.effort)
      buff.write(_struct_I.pack(length))
      pattern = '<%sd'%length
      buff.write(struct.pack(pattern, *self.action_feedback.feedback.ik_solution.joint_state.effort))
      _x = self
      ...
      for val1 in self.action_feedback.feedback.ik_solution.attached_collision_objects:
        ...
        for val3 in _v33.plane_poses:
          ...
          _x = _v42
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v33.operation))
      ...
      buff.write(_get_struct_B().pack(self.action_feedback.feedback.ik_solution.is_diff))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v47.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v47.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v47.effort = struct.unpack(pattern, str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v59.id = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v62.key = str[start:end].decode('utf-8')
          else:
          ...
          if python3:
            _v62.db = str[start:end].decode('utf-8')
          else:
      ...
      if python3:
        self.action_feedback.feedback.ik_solution.joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      self.action_feedback.feedback.ik_solution.joint_state.position = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_feedback.feedback.ik_solution.joint_state.velocity = struct.unpack(pattern, str[start:end])
      start = end
      end += 4
      (length,) = _struct_I.unpack(str[start:end])
      pattern = '<%sd'%length
      ...
      self.action_feedback.feedback.ik_solution.joint_state.effort = struct.unpack(pattern, str[start:end])
      _x = self
      start = end
      end += 12
      ...
      if python3:
        self.action_feedback.feedback.ik_solution.multi_dof_joint_state.header.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v79.id = str[start:end].decode('utf-8')
        else:
    ...
    try:
      ...
      for val1 in self.action_result.result.ik_solutions:
        ...
        for val2 in val1.attached_collision_objects:
          ...
          for val4 in _v105.plane_poses:
            ...
            _x = _v114
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v105.operation))
          length = len(val2.touch_links)
          buff.write(_struct_I.pack(length))
          for val3 in val2.touch_links:
            length = len(val3)
      ...
      for val1 in self.action_feedback.feedback.ik_solution.attached_collision_objects:
        ...
        for val3 in _v125.plane_poses:
          ...
          _x = _v134
          buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
        buff.write(_get_struct_b().pack(_v125.operation))
        length = len(val1.touch_links)
        buff.write(_struct_I.pack(length))
        for val2 in val1.touch_links:
          length = len(val2)
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v171.id = str[start:end].decode('utf-8')
        else:
