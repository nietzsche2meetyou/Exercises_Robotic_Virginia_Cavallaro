  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        _v27.position = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v27.velocity = struct.unpack(pattern, str[start:end])
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        pattern = '<%sd'%length
        ...
        _v27.effort = struct.unpack(pattern, str[start:end])
        ...
        for i in range(0, length):
          ...
          if python3:
            _v39.id = str[start:end].decode('utf-8')
          else:
      ...
      for val1 in self.result.ik_solutions:
        ...
        for val2 in val1.attached_collision_objects:
          ...
          for val4 in _v65.plane_poses:
            ...
            _x = _v74
            buff.write(_get_struct_4d().pack(_x.x, _x.y, _x.z, _x.w))
          buff.write(_get_struct_b().pack(_v65.operation))
          length = len(val2.touch_links)
          buff.write(_struct_I.pack(length))
          for val3 in val2.touch_links:
            length = len(val3)
